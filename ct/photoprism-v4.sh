...
export PCT_OPTIONS="
  ...
  $PW
"
bash -c "$(wget -qLO - https://raw.githubusercontent.com/cklam2/Proxmox/bugfix/photoprism-script-fix/ct/create_lxc.sh)" || exit
msg_info "Starting LXC Container"
pct start $CTID
msg_ok "Started LXC Container"
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/cklam2/Proxmox/bugfix/photoprism-script-fix/setup/$var_install.sh)" || exit
